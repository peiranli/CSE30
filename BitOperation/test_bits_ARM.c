...
assert(isLessOrEqual_ARM(-3,5)==test_isLessOrEqual_ARM(-3,5));
assert(isLessOrEqual_ARM(5,2)==test_isLessOrEqual_ARM(5,2));
assert(isLessOrEqual_ARM(5,-1)==test_isLessOrEqual_ARM(5,-1));
