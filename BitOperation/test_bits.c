...
assert(divpwr2(8,2)==test_divpwr2(8,2));
assert(divpwr2(-128,3)==test_divpwr2(-128,3));
printf("Passed Test Cases for divpwr2\n");

assert(isLessOrEqual(4,5)==test_isLessOrEqual(4,5));
assert(isLessOrEqual(-3,5)==test_isLessOrEqual(-3,5));
assert(isLessOrEqual(5,2)==test_isLessOrEqual(5,2));
assert(isLessOrEqual(5,-1)==test_isLessOrEqual(5,-1));
printf("Passed Test Cases for isLessOrEqual\n");

assert(ilog2(16)==test_ilog2(16));
assert(ilog2(28)==test_ilog2(28));
printf("Passed Test Cases for ilog2\n");

assert(float_neg(0x12345)==test_float_neg(0x12345));
assert(float_neg((unsigned)-1.0)==test_float_neg((unsigned)-1.0));
assert(float_neg(0.0)==test_float_neg(0.0));
printf("Passed Test Cases for float_neg\n");

assert(float_i2f(20)==test_float_i2f(20));
assert(float_i2f(0x294857)==test_float_i2f(0x294857));
printf("Passed Test Cases for float_i2f\n");

assert(float_twice(0x56)==test_float_twice(0x56));
